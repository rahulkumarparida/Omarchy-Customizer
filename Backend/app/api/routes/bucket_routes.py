...
from app.services.bucket_service import get_all_bucket_theme,save_bucket_theme,apply_bucket_theme,get_bucket_data , delete_bucket_theme
...
@bucket_router.delete('/{id}')
def remove_bucket(id:int):
    return delete_bucket_theme(id)
