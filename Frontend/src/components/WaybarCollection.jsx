...
const themesData = [
  { id: 1, creator: "Username", githubLink: "#", imageUrl: exampleThemeImage },
  { id: 2, creator: "Another User", githubLink: "#", imageUrl: exampleThemeImage },
  { id: 3, creator: "ThemeMaster", githubLink: "#", imageUrl: exampleThemeImage },
  { id: 4, creator: "CreativeCoder", githubLink: "#", imageUrl: exampleThemeImage },
  { id: 5, creator: "ArtisticMind", githubLink: "#", imageUrl: exampleThemeImage },
  { id: 6, creator: "DevDesign", githubLink: "#", imageUrl: exampleThemeImage },
];
...
const ThemeCard = ({ creator, imageUrl, cardRef }) => (
  <article
    ref={cardRef}
  ...
  >
    ...
    <div className="w-full text-left">
      ...
      <h3 className="mt-3 text-2xl font-semibold text-white">{creator}</h3>
    </div>
