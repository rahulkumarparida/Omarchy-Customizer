...
const OmarchyThemeDetailsPage = () => {
  ...
  async function fetchOmarchyDetails() {
    let response =await api.get(`/api/theme/hypr/${id}`)
  ...
  useEffect(() => {
    fetchOmarchyDetails().then((result) => {
